...
const getOrdersOptions = () => {
    let textColor = getComputedStyle(document.body).getPropertyValue('--text-color') || 'rgba(0, 0, 0, 0.87)';
    let gridLinesColor = getComputedStyle(document.body).getPropertyValue('--divider-color') || 'rgba(160, 167, 181, .3)';
    let fontFamily = getComputedStyle(document.body).getPropertyValue('--font-family');
    return {
        plugins: {
            legend: {
                display: true,
...
class Dashboard extends React.Component {
    ...
    getOverviewColors = () => {
        let isLight = this.props.colorMode === 'light';
        return {
    ...
    // setOverviewColors = () => {
    //     { pinkBorderColor, pinkBgColor, tealBorderColor, tealBgColor } = getOverviewColors();
    ...
    actionTemplate = (rowData, column) => {
        return (
            <>
                ...
                <Button icon="pi pi-search" type="button" className={classNames('p-button-rounded p-button-text p-mb-1', { 'p-mr-2': !this.state.isRTL, 'p-ml-2': this.state.isRTL })}></Button>
            </>
        )
    }

    priceBodyTemplate = (data) => {
        return (
            <>
                ...
                <div className="p-col-12 p-md-6 p-lg-3">
                    <div className="card overview-box p-d-flex p-flex-column p-pt-2">
                        <div className="p-d-flex p-ai-center muted-text">
                            ...
                            <h6 className={classNames('p-m-0', { 'p-pl-2': !this.state.isRTL, 'p-pr-2': this.state.isRTL })} >Orders</h6>
                            <div className={classNames({ 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu1.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu1 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                        <div className="p-d-flex p-jc-between p-mt-3 p-flex-wrap">
                            ...
                            <div className="p-d-flex p-ai-end">
                                <Chart ref={ref => this.chart1 = ref} type="line" data={overviewChartData1} options={overviewChartOptions} height="60px" width="160px"></Chart>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-col-12 p-md-6 p-lg-3">
                    <div className="card overview-box p-d-flex p-flex-column p-pt-2">
                        <div className="p-d-flex p-ai-center muted-text">
                            ...
                            <h6 className={classNames('p-m-0', { 'p-pl-2': !this.state.isRTL, 'p-pr-2': this.state.isRTL })}>Revenue</h6>
                            <div className={classNames({ 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu2.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu2 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                        <div className="p-d-flex p-jc-between p-mt-3 p-flex-wrap">
                            <div className="p-d-flex p-flex-column" style={{ width: '80px' }}>
                ...
                <div className="p-col-12 p-md-6 p-lg-3">
                    <div className="card overview-box p-d-flex p-flex-column p-pt-2">
                        <div className="p-d-flex p-ai-center muted-text">
                            ...
                            <h6 className={classNames('p-m-0', { 'p-pl-2': !this.state.isRTL, 'p-pr-2': this.state.isRTL })}>Customers</h6>
                            <div className={classNames({ 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu3.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu3 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                        <div className="p-d-flex p-jc-between p-mt-3 p-flex-wrap">
                            <div className="p-d-flex p-flex-column" style={{ width: '80px' }}>
                ...
                <div className="p-col-12 p-md-6 p-lg-3">
                    <div className="card overview-box p-d-flex p-flex-column p-pt-2">
                        <div className="p-d-flex p-ai-center muted-text">
                            ...
                            <h6 className={classNames('p-m-0', { 'p-pl-2': !this.state.isRTL, 'p-pr-2': this.state.isRTL })}>Comments</h6>
                            <div className={classNames({ 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu4.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu4 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                        <div className="p-d-flex p-jc-between p-mt-3 p-flex-wrap">
                            <div className="p-d-flex p-flex-column" style={{ width: '80px' }}>
                ...
                <div className="p-col-12 p-lg-6">
                    <div className="card height-100">
                        <div className="card-header">
                            <h5>Contact</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu5.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu5 = ref} popup model={[{ label: 'New', icon: 'pi pi-fw pi-plus' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }, { label: 'Delete', icon: 'pi pi-fw pi-trash' }]}></Menu>
                            </div>
                        </div>
                        ...
                        <ul className="widget-list">
                            <li className="p-d-flex p-ai-center p-py-3">
                                <div className="person-item p-d-flex p-ai-center">
                                    ...
                                    <div className={classNames({ 'p-ml-2': !this.state.isRTL, 'p-mr-2': this.state.isRTL })}>
                                        <div>Xuxue Feng</div>
                                        <small className="muted-text">feng@ultima.org</small>
                                    </div>
                                </div>
                                <span className={classNames('person-tag indigo-bgcolor p-p-1 fs-small', { 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>Accounting</span>
                                <span className={classNames('person-tag orange-bgcolor p-p-1 fs-small', { 'p-ml-2': !this.state.isRTL, 'p-mr-2': this.state.isRTL })}>Sales</span>
                            </li>
                            ...
                            <li className="p-d-flex p-ai-center p-py-3">
                                ...
                                <span className={classNames('person-tag teal-bgcolor p-p-1 fs-small', { 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>Finance</span>
                                <span className={classNames('person-tag orange-bgcolor p-p-1 fs-small', { 'p-ml-2': !this.state.isRTL, 'p-mr-2': this.state.isRTL })}>Sales</span>
                            </li>
                            ...
                            <li className="p-d-flex p-ai-center p-py-3">
                                ...
                                <span className={classNames('person-tag pink-bgcolor p-p-1 fs-small', { 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>Management</span>
                            </li>
                            ...
                            <li className="p-d-flex p-ai-center p-py-3">
                                ...
                                <span className={classNames('person-tag pink-bgcolor p-p-1 fs-small', { 'p-ml-auto': !this.state.isRTL, 'p-mr-auto': this.state.isRTL })}>Management</span>
                                <span className={classNames('person-tag teal-bgcolor p-p-1 fs-small', { 'p-ml-2': !this.state.isRTL, 'p-mr-2': this.state.isRTL })}>Finance</span>
                            </li>
                ...
                <div className="p-col-12 p-lg-6">
                    <div className="card height-100">
                        <div className="card-header">
                            <h5>Order Graph</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu6.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu6 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                ...
                <div className="p-col-12 p-lg-6">
                    <div className="card height-100 widget-timeline">
                        <div className="card-header">
                            <h5>Timeline</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu7.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu7 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>

                        <Timeline value={this.state.timelineEvents} align="left" className="customized-timeline" marker={this.marker} content={this.content} />
                    </div>
                </div>

                <div className="p-col-12 p-md-12 p-lg-6">
                    <div className="card height-100">
                        <DataTable value={this.state.products} paginator rows={8} className="p-datatable-products"
                            selection={this.state.selectedProduct} onSelectionChange={(e) => this.setState({ selectedProduct: e.value })}>
                            <Column header="Image" body={this.imageTemplate} style={{ width: '5rem' }} />
                            <Column field="name" body={this.bodyTemplate} header="Name" sortable />
                            <Column field="category" body={this.bodyTemplate} header="Category" sortable />
                            <Column field="price" body={this.priceBodyTemplate} header="Price" sortable />
                            <Column header="View" body={this.actionTemplate} style={{ width: '4rem' }} />
                        </DataTable>
                    </div>
                </div>
                ...
                <div className="p-col-12 p-lg-6">
                    <div className="card height-100">
                        <div className="card-header">
                            <h5>Chat</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu8.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu8 = ref} popup model={[{ label: 'View Media', icon: 'pi pi-fw pi-images' }, { label: 'Starred Messages', icon: 'pi pi-fw pi-star-o' }, { label: 'Search', icon: 'pi pi-fw pi-search' }]}></Menu>
                            </div>
                        </div>
                        <div className="widget-chat">
                            <ul ref={ref => this.chatcontainer = ref}>
                                {
                                    this.state.chatMessages.map((chatMessage, i) => {
                                        let last = i === this.state.chatMessages.length - 1;
                                        return <li key={i} className={classNames('p-d-flex p-ai-start', { 'from': chatMessage.from, 'own p-jc-end': !chatMessage.from, 'p-mb-3': !last, 'p-mb-1': last })}>
                                            {chatMessage.url && <img src={chatMessage.url} alt="avatar" className={classNames({ 'p-mr-2': !this.state.isRTL, 'p-ml-2': this.state.isRTL })} />}
                            ...
                            <div className="p-inputgroup write-message p-mt-3">
                                ...
                                <InputText placeholder="Write your message (Hint: 'PrimeReact')" onKeyDown={this.onChatKeydown} />
                                <span className="p-inputgroup-addon">
                                ...
                                <span className="p-inputgroup-addon">
                                    ...
                                    <OverlayPanel ref={ref => this.op = ref} className="emoji">
                                        {
                                            this.state.chatEmojis.map((emoji, i) => {
                ...
                <div className="p-col-12 p-lg-3">
                    <div className="card height-100">
                        <div className="card-header">
                            <h5>Activity</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu9.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu9 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                ...
                <div className="p-col-12 p-lg-3">
                    <div className="card height-100">
                        <div className="card-header">
                            <h5>Best Sellers</h5>
                            <div>
                                <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text p-button-plain" onClick={(event) => this.menu10.current.toggle(event)}></Button>
                                <Menu ref={ref => this.menu10 = ref} popup model={[{ label: 'Update', icon: 'pi pi-fw pi-refresh' }, { label: 'Edit', icon: 'pi pi-fw pi-pencil' }]}></Menu>
                            </div>
                        </div>
                        <ul className="widget-bestsellers">
                            <li>
                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/blue-band.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Blue Band</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/bracelet.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Bracelet</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/black-watch.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Black Watch</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/bamboo-watch.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Bamboo Watch</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/blue-t-shirt.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Blue T-Shirt</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/game-controller.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Game Controller</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/gold-phone-case.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
                                    <span>Phone Case</span>
                                    <span className="item-button"><button className="p-link"><i className="pi pi-chevron-right"></i></button></span>
                                </div>

                                <div className="bestseller-item p-d-flex p-ai-center p-p-3 p-mb-2">
                                    <img src="assets/demo/images/product/purple-t-shirt.jpg" alt="product" className={classNames({ 'p-mr-3': !this.state.isRTL, 'p-ml-3': this.state.isRTL })} />
