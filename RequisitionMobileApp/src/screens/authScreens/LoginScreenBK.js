...
import { images, width, height, bgColorCode, sessionKeys, ApiHelper, useLocalURL } from "../../utilities/ConstVariables";
...
export default class LoginScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    if (useLocalURL) {
      let lgnReqObj = {
        mobileNumber: "david@spartanfitness.com",
        password: "Dastagir@123"
      }
      this.setState({ loginRequestObj: lgnReqObj });
    }
  }
  ...
  changeCredintials(role) {
    if (useLocalURL) {
      switch (role) {
        case "FD":
          this.setState({ loginRequestObj: { mobileNumber: "mencip@kecc.me", password: "Dastagir@123" } });
          break;
        case "Approver":
          this.setState({ loginRequestObj: { mobileNumber: "faris@kecc.me", password: "Dastagir@123" } });
          break;
        case "Requ":
          this.setState({ loginRequestObj: { mobileNumber: "david@spartanfitness.com", password: "Dastagir@123" } });
          break;
        default:
          this.setState({ loginRequestObj: { mobileNumber: "", password: "" } });
          break;
      }
    }
  }
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ImageBackground source={images.commonBackgroundImage} style={{ flex: 1, width: width, height: height }}>
          <View style={{ width: width, height: height, flex: 1, padding: 30, alignItems: "center", justifyContent: "center" }}>
            ...
            <TouchableOpacity onPress={() => this.changeCredintials("Requ")}>
              <Text style={{ fontFamily: "Calibre-Medium", fontWeight: "bold", fontSize: 28, color: "black", marginBottom: 20 }}>Login</Text>
            </TouchableOpacity>
            <View style={{ marginBottom: 15 }}>
              <TouchableOpacity onPress={() => this.changeCredintials("Approver")}>
            ...
            <View style={{ marginBottom: 15 }}>
              <TouchableOpacity onPress={() => this.changeCredintials("FD")}>
